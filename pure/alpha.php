...
<html>
    ...
    <body>
                ...
                <ul>
                    <li class="dwrap"><a>Accueil</a>
                        <ul class="sub">
                            ...
                            <li><a href="main_links/news_agenda.php">Agenda</a></li>
                            <!-- <li><a href="main_links/news_plan.php">Plan du site</a></li> -->
                        </ul>
                    </li>
                    <li class="dwrap"><a>Neurologie</a>
                        <ul class="sub">
                            <li><a href="main_links/news_neuro.php">Actu neuro</a></li>
                            <li><a href="firelink/htmlpharma/neuro.php">Tabel Neuro</a></li>
                            <li><a href="main_links/ttt_neuro.php">Actu médics</a></li>
                        </ul>
                    </li>
                    <li class="dwrap"><a>Psychiatrie</a>
                        <ul class="sub">
                            <li><a href="main_links/news_psy.php">Actu psy</a></li>
                            <li><a href="firelink/htmlpharma/psy.php">Tabel PSY</a></li>
                            <li><a href="main_links/ttt_psy.php">Actu médics</a></li>
                        </ul>
                    </li>
        ...
        <div class="all">
            <div class="security">
                <div class="info_user">
                    <h2 class="anim">Informations aux utilisateurs :</h2>
                </div>
            ...
            <div class="loader">
                <h1>05/06/2019 : Survol du site (en résumé)</h1>
                <div class="betwins">
                </div>
                <p>Vous pouvez trouver sur Heidi :</p>
                    <ul>
