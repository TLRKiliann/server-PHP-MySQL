...
<html>
    <head>
	<meta charset="Utf-8" />
        <link rel="stylesheet" href="../css/snm.css" type="text/css" /> 
    ...
    <body>
        <div id="bloc_page"> 
            ...
            <div id="banniere_image">
                <div class="banni">
                    <a>Syndrome Neuroleptique Malin</a>
                </div>
                <div id="banniere_description">
                    <a href="sep.php" class="bouton_rouge2">Précédent</a>
                    <a href="syndsero.php" class="bouton_rouge">Suivant</a>
                </div>
            </div>
            ...
            <section>
                <article>
                    <h1><img src="../images/snm_2.png" alt="Les épilepsies" class="ico_categorie" /><strong>Syndrome neuroleptique malin</strong></h1>
                    <h3>Symptomes</h3>

                    <p><strong>Fièvre persistante plus de 24 heures sans symptômes infectieux</strong></p>

                        <ul>
                            <li><a>Rigidité</a></li>
                            <li><a>Tachycardie</a></li>
                            <li><a>Syndrome bucco-laringuo-masticateurs et striction de la gorge</a></li>
                            <li><a>Agitation incoercible ou akinésie</a></li>
                            <li><a>Hypersialorrhée</a></li>
                            <li><a>Transpiration profuse</a></li>
                        </ul>

                    <p><strong>Après plus de 24 heures</strong></p>

                        <ul>
                            <li><a>Instabilité tensionnelle</a></li>
                            <li><a>Fièvre à plus de 40°C</a></li>
                            <li><a>Hypersialorrhée</a></li>
                            <li><a>Hypertonie avec rigidité plastique</a></li>
                            <li><a>Des phénomènes dyskinétiques</a></li>
                            <li><a>Polypnée, risques d'encombrements pulmonaires</a></li>
                            <li><a>Incontinence urinaire</a></li>
                        </ul>
                    <div class="impo_rouge">
                        <p><mark>Il est impératif d'agir dans les plus brefs délais. Il s'agit d'une urgence vitale! Il y a un risque de mort au-delà de 36 heures !</mark></p>
                    </div>
                </article>
            </section>
