...
<html>
    <head>
	<meta charset="Utf-8" />
        <link rel="stylesheet" href="../css/tsa.css" type="text/css" /> 
        ...
        <div id="bloc_page">  
            ...
            <div id="banniere_image">
                <div id="banniere_description">
                    ...
                    <a href="neuro.php" class="bouton_rouge">Suivant</a>
                </div>
            </div>

            <section>
                <article>
                    <h1><img src="../images/tsa_2.png" alt="Les épilepsies" class="ico_categorie" /><strong>Autisme</strong></h1>
            ...
            <footer>
                <div class="black_band">
                    ...
                    <div id="mes_photos">
                        ...
                        <p><img src="../images/main.jpg" alt="Photographie" /><img src="../images/pieds.jpg" alt="Photographie" /><img src="../css/photo3.jpg" alt="Photographie" /><img src="../css/photo4.jpg" alt="Photographie" /></p>
                    </div>

                    <div id="medics">
                        <h1>Quelques familles de médicaments:</h1>
                        <div id="listes_ttt">
                            <ul>
                                <li><a href="epilepsie.php">Epilepsie</a></li>
                                <li><a href="#">Syndrome Pakinsonien</a></li>
                                <li><a href="#">Syndrome extrapyramidal</a></li>
                                <li><a href="#">Sclérose latérale amyotrophique</a></li>
                                <li><a href="epilepsie.php">Syndrome de Lennox-Gastaut</a></li>
                            </ul>

                            <ul>
                                <li><a href="#">Neurofibromatose de type 1 et 2</a></li>
                                <li><a href="#">Camptocormie</a></li>
                                <li><a href="page2.php">Guilain-Barré</a></li>
                                <li><a href="page3.php">Encéphalopatie</a></li>
                                <li><a href="html/page3.php">Maladies dégénératives</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
