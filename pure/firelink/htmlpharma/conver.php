...
<html>
    <head>
	<meta charset="Utf-8" />
        <link rel="stylesheet" href="../css/conver.css" type="text/css" /> 
        ...
        <div id="bloc_page">
            ...
            <div id="banniere_image">
                ...
                <div id="banniere_description">
                    <a href="hypocon.php" class="bouton_rouge2">Précédent</a>
            ...
            <section>
                <article>
                    <h1><img src="../images/psy.png" alt="Les épilepsies" class="ico_categorie" /><strong>Conversion</strong></h1>
                        <p>Le trouble de conversion comprend un ou plusieurs symptômes ou déficits produits inconsciemment et involontairement, touchant la motricité volontaire ou les fonctions sensitives ou sensorielles.
                           Les manifestations ressemblent à une affection neurologique ou médicale générale, mais relève de façon rare d'un substrat physiopathologique ou de voies anatomiques connues. Des facteurs
                           psychologiques ou le stress en sont à l'origine. Le diagnostic repose sur l'anamnèse après l'exclusion des symptômes physiques.</p>

                        <p>La conversion peut débuter à tout âge. Elle touche plus fréquemment la femme. Les symptômes de conversion isolés peuvent ne pas remplir complètement les critères du trouble de conversion.</p>

                    <h3>Symptomatologie et diagnostic</h3>
                        <p>Les symptômes peuvent se manifester par : des troubles de la coordination, ou de l'équilibre, paralysie ou faiblesse musculaire d'un membre ou perte de la sensibilité d'une partie du corps,
                           crises convulsives, cécité, diplopie, surdité, aphonie, difficulté de déglutition, rétention urinaire.</p>

                        <p>Les symptômes sont suffisamment sévères pour entraîner un malaise ou altérer le fonctionnement social, professionnel, ou dans d'autres domaines importants. Les épisodes sont généralement
                           courts. Un patient présentera soit un seul épisode soit plusieurs épisodes répétés de conversion. Les symptômes peuvent devenir chroniques.</p>

                        <p>Le diagnostic n'est envisagé qu'après qu'un examen clinique et des examens complémentaires ont exclu une affection médicale qui puisse expliquer totalement les symptômes et leurs effets. 

                    <h3>Traitement</h3>
                        <p>Une relation thérapeutique marquée par l'empathie et le soutien est essentielle. Le médecin élimine un trouble physique et rassure le patient sur ses symptômes qui ne sont pas en rapport avec 
                           une affection grave. L'hypnose, la narcoanalyse, une thérapie comportementale, des exercices de relaxation peuvent être utiles.</p>

                    <p><i>Manuel Merck - 4ème édition - Merck research Laboratories - Division de Merck & Co., Inc., Whithouse Station, N.J. 2006, p. 1737-1738.</i></p>
